...
from django.views.generic import ListView  # Importamos ListView, una "vista genérica" muy útil de Django.
                                           # ListView está diseñada específicamente para mostrar listas de objetos de un modelo.
from .models import Post  # Importamos el modelo 'Post' desde el archivo models.py de nuestra misma aplicación.
